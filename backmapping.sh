...
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').sam
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').bam
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').s.bam.bam.bam
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').allheaders; 
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').nameLenZerocov; 
rm $(basename $line1 | sed 's/_gapcloser.fasta//g')_$(basename $line2 | sed 's/.fastq//g').headers;  
