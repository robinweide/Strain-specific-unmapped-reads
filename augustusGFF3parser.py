...
with numpy.errstate(all='ignore'):
    ...
    st.write('Length protein-coding seqs\tSum\t' + str(numpy.sum(Coding, axis=0))+ "\n")
    ...
    st.write('Length non-coding seqs\tSum\t' + str(numpy.sum(nonCoding, axis=0))+ "\n")
    ...
    st.write('Length protein-coding AA\tSum\t' + str(numpy.sum(AA, axis=0))+ "\n")
inputGFF3.close()
st.close()
fa.close()
