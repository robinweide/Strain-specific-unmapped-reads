...
`\/home\/robin\/bin\/bwa\-0\.7\.5a\/bwa mem \-c 200 \-M \/data\_fedor12\/robin\/databases\/ViPro\/ProVi\.fa vipro\_m1\.fq vipro\_m2\.fq \> viproR\.sam`;
# get organisms that properly map in pairs
`samtools view \-S \-f 2 viproR\.sam \| cut \-f3 \| sort \| uniq \-c \|sort \-nr \> Baudoinia_bits.log`;
